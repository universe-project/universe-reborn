...
const string strMessageMagic = "Universe Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Universe", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "08.03.2017";
        CTransaction txNew;
        txNew.nTime = 1489009628;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1489009628;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 239542 : 239542;
        ...
        assert(block.hashMerkleRoot == uint256("0x7c98bc2199ded0913eb0e9de5fe0befe68d2cc7e94112a516e7e26eef37b7287"));
...
unsigned char pchMessageStart[4] = { 0x57, 0x46, 0xf2, 0x84 };
